...
export default function AboutScreen() {
    return (
        <div>
            ...
            <h2 class="mb-4 text-center">Wisdom : E-Learning Platform</h2>
            <div align="center">
            <img
             src={Img9}
             alt="Learn"/>
        ...
        <Card.Text>
         Wisdom is the best place to learn and improve your knowledge. The best thing about this training is its high quality informative videos.
        </Card.Text>
        </Card.Body>
        </Card>
        </Col>
        ...
        <Card.Text>
         Wisdom is one of the best platform. Because of the training content which helped to improve your skill & knowledge. To learn many more things.
        </Card.Text>
        </Card.Body>
        </Card>
        </Col>
        ...
        <Card.Text>
         Wisdom is one of the best platform. To learn different types of courses with mininmum price. My favorite course is "ML" Love it !
        </Card.Text>
        </Card.Body>
        </Card>
        </Col>
        ...
        <Card.Text>
         Wisdom is one of the best platform. To learn different types of courses with mininmum price. My favorite course is "ML" Love it !         </Card.Text>
        </Card.Body>
        </Card>
        </Col>
